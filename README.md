# First_Project
Analytics of E-commerce via Python

Проект e-commerce от Karpov.Courses: вариант 1 
Задание: "Продакт-менеджер Василий попросил вас проанализировать совершенные покупки и ответить на следующие вопросы":
